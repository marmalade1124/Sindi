...
import { View, Text, TouchableOpacity, SafeAreaView, ScrollView, ActivityIndicator, RefreshControl, StyleSheet, Platform, StatusBar as RNStatusBar } from 'react-native';
